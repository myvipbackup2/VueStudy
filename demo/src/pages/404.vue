<template>
    ...
    <g id="head" class="up">
        <g id="leftAntenna">
            <path fill="none" stroke="#ccc" stroke-width="1.5" stroke-miterlimit="10" d="M 77.519 25.869 C 75.85 13.604 65.745 3.39 53.972 2.10217">
            ...
            <ellipse fill="#ccc" cx="55.021" cy="2.10217" rx="3.344" ry="3.391">
        ...
        <g id="rightAntenna">
            <path fill="none" stroke="#ccc" stroke-width="1.5" stroke-miterlimit="10" d="M 82.48 25.869 C 84.15 13.604 94.255 3.39 106.028 -1.48417">
            ...
            <ellipse fill="#ccc" cx="104.979" cy="-1.48417" rx="3.344" ry="3.391">
        ...
        <g>
            <g id="eyeLeft">
                <path fill="#FFFFFF" d="M 72.116 47.955 c 0 5.443 -3.44847 9.853 -9.033 9.853 h -1.971 c -4.988 0 -9.032 -4.41 -9.032 -9.853 s 4.044 -9.11034 9.032 -9.11034 h 1.971 C 68.071 39.1429 72.116 42.512 72.116 47.955 Z">
            ...
            <g>
                <path fill="#FFFFFF" d="M 107.92 47.955 c 0 5.443 -4.045 9.853 -9.031 9.853 h -1.973 c -4.986 0 -9.031 -4.41 -9.031 -9.853 s 4.045 -9.11034 9.031 -9.11034 h 1.973 C 103.875 39.1429 107.92 42.512 107.92 47.955 Z">
                    <animate attributeName="d" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1" begin="5s" dur="0.8s" repeatCount="indefinite" values="
        ...
        <path fill="#FFFFFF" d="M 103.383 69.778 c 0 1.381 -0.841188 2.54764 -1.871 2.499 c -10.8673 -0.541698 -31.769 -0.475769 -43.025 0 c -1.02997 0.0369634 -1.871 -1.118 -1.871 -2.499 c 0 -1.378 0.84924 -2.56582 1.871 -2.496 c 11.7147 1.07972 31.8713 0.742078 43.025 0 C 102.539 67.2232 103.383 68.4 103.383 69.778 Z">
